<div id="menu">
        <ul>
            ...
            <ul id="sub_menu">
                <?php
                    $sql = "select hsp.MaLoaiSanPham, h.MaHangSanXuat, h.TenHangSanXuat from hangsanxuat h, hangsanxuat_loaisanpham hsp where h.MaHangSanXuat = hsp.MaHangSanXuat and hsp.MaLoaiSanPham = $MaLoaiSanPham and h.BiXoa = 0";
